...
def estimate_hidden_transition_log(data, forward_log, backward_log, transition_log, emission_log, norm):

    hidden_state_prob_log = calc_hidden_state_prob_log(forward_log, backward_log, norm=norm)
...
def estimate_hidden_transition(data, forward, backward, transition, emission, norm):
    ...
    transition_prob = calc_transition_prob(data, forward, backward, transition, emission,
                                               norm=norm)
